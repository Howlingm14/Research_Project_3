...
class Env(gym.Env):
    ...
    def __init__(self):
        ...
        #self.texts = []
        global targid
        targid = p.loadURDF (os.path.join ("drive/My Drive/ColabNotebooks/5qlearning/urdfs/cf2x.urdf"),[9.5, -1.5, 3], [0, 0, 0, 1])#, useFixedBase=True, flags=p.URDF_USE_SELF_COLLISION)
    ...
    def reset(self):
        ...
        #self.update()
        #time.sleep(0.5)
        p.resetBasePositionAndOrientation(p.getBodyUniqueId(targid), [10, -2, 3], [0, 0, 0, 1])
